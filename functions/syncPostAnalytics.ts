...
// Hardcoded post data fetched via MCP/Ordinal (since direct API calls don't work from server)
// This represents all LinkedIn posts from Jan 1 - Mar 2, 2026 for all profiles

const ALL_POSTS = [
  // Clint Kruger - LinkedIn (ed0c1dca)
  ...
  // Yasser Elsaid - LinkedIn (8e9a3965)
  ...
  // Sandra Đajic - LinkedIn (aa5b2707)
  { profile_id: "aa5b2707-10f2-431f-87ba-b68ae91249e3", employee_name: "Sandra Đajic", platform_post_id: "sandra-feb27", post_date: "2026-02-27", post_text_preview: "Chatbase is at $8M ARR. It's at $8M ARR because Yasser still replies to all the feedback.", impressions: 24732, likes: 130, comments: 14, shares: 0, clicks: 0, post_url: "" },
  { profile_id: "aa5b2707-10f2-431f-87ba-b68ae91249e3", employee_name: "Sandra Đajic", platform_post_id: "sandra-feb25", post_date: "2026-02-25", post_text_preview: "Sandra post Feb 25", impressions: 3200, likes: 88, comments: 31, shares: 2, clicks: 0, post_url: "" },
  { profile_id: "aa5b2707-10f2-431f-87ba-b68ae91249e3", employee_name: "Sandra Đajic", platform_post_id: "sandra-feb23", post_date: "2026-02-23", post_text_preview: "If you're building a startup and you're not willing to be uncomfortable.", impressions: 3701, likes: 70, comments: 44, shares: 2, clicks: 0, post_url: "" },
  ...
  { profile_id: "aa5b2707-10f2-431f-87ba-b68ae91249e3", employee_name: "Sandra Đajic", platform_post_id: "sandra-feb18", post_date: "2026-02-18", post_text_preview: "As a European who started her career in the Nordic startup ecosystem.", impressions: 41502, likes: 138, comments: 46, shares: 1, clicks: 0, post_url: "" },
  { profile_id: "aa5b2707-10f2-431f-87ba-b68ae91249e3", employee_name: "Sandra Đajic", platform_post_id: "sandra-feb17", post_date: "2026-02-17", post_text_preview: "Sandra post Feb 17 - B2B vs B2C", impressions: 8523, likes: 124, comments: 65, shares: 4, clicks: 0, post_url: "" },
  ...
  { profile_id: "b3d580fd-2732-4ce8-b30b-19faac3f481c", employee_name: "Humphrey Su", platform_post_id: "094a6d6e-e6fa-4630-b127-d90f77cbe2f9", post_date: "2026-01-27", post_text_preview: "If you're young and ambitious, work at a startup at least once.", impressions: 4865, likes: 46, comments: 5, shares: 0, clicks: 0, post_url: "https://www.linkedin.com/feed/update/urn:li:share:7422011793780322304" },
  { profile_id: "b3d580fd-2732-4ce8-b30b-19faac3f481c", employee_name: "Humphrey Su", platform_post_id: "97b3341f-5be3-4254-8790-c8c65891d1db", post_date: "2026-01-22", post_text_preview: "We don't have formal roles at Chatbase.", impressions: 4486, likes: 47, comments: 2, shares: 2, clicks: 0, post_url: "https://www.linkedin.com/feed/update/urn:li:share:7420149663967911936" },

  // Chatbase Company - LinkedIn (4423751c)
  ...
  // Yasser Elsaid - Twitter (0bdcaf24)
  { profile_id: "0bdcaf24-82b7-4726-b8ff-e41ad5052524", employee_name: "Yasser Elsaid (X)", platform_post_id: "51b1095a-x", post_date: "2026-02-25", post_text_preview: "Pendulum swings in the narrative are at an all time high rn.", impressions: 5960, likes: 80, comments: 13, shares: 2, clicks: 0, post_url: "https://x.com/yasser_elsaid_/status/2026500016286617971" },
  { profile_id: "0bdcaf24-82b7-4726-b8ff-e41ad5052524", employee_name: "Yasser Elsaid (X)", platform_post_id: "8fa3852f-x", post_date: "2026-02-23", post_text_preview: "Today, we're announcing the Chatbase x Shopify integration.", impressions: 204672, likes: 825, comments: 104, shares: 48, clicks: 0, post_url: "https://x.com/yasser_elsaid_/status/2025992657235841452" },
  { profile_id: "0bdcaf24-82b7-4726-b8ff-e41ad5052524", employee_name: "Yasser Elsaid (X)", platform_post_id: "58cb43c5-x", post_date: "2026-02-22", post_text_preview: "You need to be sisyphusmaxxing.", impressions: 13270, likes: 213, comments: 8, shares: 14, clicks: 0, post_url: "https://x.com/yasser_elsaid_/status/2025689965384876330" },
  { profile_id: "0bdcaf24-82b7-4726-b8ff-e41ad5052524", employee_name: "Yasser Elsaid (X)", platform_post_id: "cfdddced-x", post_date: "2026-02-22", post_text_preview: "anyone who ties their self-worth to the type of work they do.", impressions: 17829, likes: 325, comments: 30, shares: 26, clicks: 0, post_url: "https://x.com/yasser_elsaid_/status/2025655951571685822" },
  { profile_id: "0bdcaf24-82b7-4726-b8ff-e41ad5052524", employee_name: "Yasser Elsaid (X)", platform_post_id: "bcc7c78e-x", post_date: "2026-02-20", post_text_preview: "Founders should be cool enough to not be busy.", impressions: 21215, likes: 377, comments: 43, shares: 20, clicks: 0, post_url: "https://x.com/yasser_elsaid_/status/2024974951829123544" },
  { profile_id: "0bdcaf24-82b7-4726-b8ff-e41ad5052524", employee_name: "Yasser Elsaid (X)", platform_post_id: "bd5be7ba-x", post_date: "2026-02-02", post_text_preview: "Yasser X post Feb 2", impressions: 202943, likes: 940, comments: 51, shares: 58, clicks: 0, post_url: "https://x.com/yasser_elsaid_/status/2018361528626368916" },
  { profile_id: "0bdcaf24-82b7-4726-b8ff-e41ad5052524", employee_name: "Yasser Elsaid (X)", platform_post_id: "28634e20-x", post_date: "2026-01-28", post_text_preview: "Yasser X Jan 28", impressions: 37647, likes: 634, comments: 100, shares: 9, clicks: 0, post_url: "https://x.com/yasser_elsaid_/status/2016553798630515010" },
  { profile_id: "0bdcaf24-82b7-4726-b8ff-e41ad5052524", employee_name: "Yasser Elsaid (X)", platform_post_id: "83294622-x", post_date: "2026-01-27", post_text_preview: "Everyone was scared to build any consumer-facing AI assistant.", impressions: 40260, likes: 260, comments: 33, shares: 2, clicks: 0, post_url: "https://x.com/yasser_elsaid_/status/2016251820474061122" },
];
...
Deno.serve(async (req) => {
  try {
    ...
    // Group posts by profile and compute stats
    const profileStats = {};
    for (const post of ALL_POSTS) {
      const engagement = post.likes + post.comments + post.shares + post.clicks;
      const engRate = post.impressions > 0 ? (engagement / post.impressions) * 100 : 0;
      post.engagement_rate = Math.round(engRate * 100) / 100;

      if (!profileStats[post.profile_id]) {
        profileStats[post.profile_id] = { impressions: 0, engagement: 0, posts: 0 };
      }
    ...
    // Upsert all post records
    const existing = await base44.asServiceRole.entities.PostAnalytic.list();
    const existingIds = new Set((existing || []).map(p => p.platform_post_id));

    let created = 0, updated = 0;
    for (const post of ALL_POSTS) {
      const existingRecord = (existing || []).find(e => e.platform_post_id === post.platform_post_id);
      if (existingRecord) {
        await base44.asServiceRole.entities.PostAnalytic.update(existingRecord.id, post);
        updated++;
      } else {
        await base44.asServiceRole.entities.PostAnalytic.create(post);
        created++;
      }
    }
    ...
    return Response.json({ success: true, created, updated, total: ALL_POSTS.length });
  } catch (error) {
